...
<head>
    ...
    <title>Easy And Healthy Recipes</title>
</head>
...
<body>
    <header>
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="">Easy & Health</a>
        ...
        <div class="jumbotron text-center">
            <h1 class="text-uppercase">Easy and Healthy Recipes</h1>
            
            <p class="mb-0">Want to eat healthy and keep it simple? We have the best easy and healthy recipes for your lifestyle. Start with great ingredients and let them shine so you shine, too!</p>
        </div>
    </header>
    <section>
        <div class="container">
            <div class="row mb-5">
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="oats.php">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/tahini.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">EASY & HEALTHY</h6>
                                <p class="card-text">OAT AND TAHINI COOKIES</p>
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">27 mins
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/spring.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">EASY & HEALTHY</h6>
                                <p class="card-text">SPRING SUCCOTASH</p>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/soup.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">EASY & HEALTHY</h6>
                                <p class="card-text">BROCCOLI AND APPLE SOUP</p>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/granola.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">EASY & HEALTHY</h6>
                                <p class="card-text">HOLIDAY SPICE GRANOLA</p>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/quiona.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">EASY & HEALTHY</h6>
                                <p class="card-text">HOW TO COOK QUINOA</p>
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">25 mins
                                    <img class="ml-md-5" src="food_recipe_css/5star.png" height="30px" width="120px" alt=""></p>
                            </div>
                        </div>
