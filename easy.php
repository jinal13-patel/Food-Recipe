...
<head>
    ...
    <met<link rel="stylesheet" type="text/css" href="food_recipe_css/h1.css">
...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <h1 class="text-capitalize">Easy Breakfast Recipes</h1>
            <p class="mb-0">Breakfast on the run? We have all the easy ideas and recipes you need for healthy start!</p>
        </div>
    </header>
    <section>
                    ...
                    <a href="#">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">28 mins <img class="ml-md-5" src="food_recipe_css/4star.png" height="30px" width="120px" alt=""></p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="#">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">17 mins <img class="ml-md-5" src="food_recipe_css/5star.png" height="30px" width="120px" alt=""></p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="#">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">25 mins <img class="ml-md-5" src="food_recipe_css/4.5star.jpg" height="40px" width="125px" alt=""></p>
                            </div>
                        </div>
                    </a>
                </div>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/muffins.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">HEALTHY BREAKFAST</h6>
                                <p class="card-text">ORANGE-SPICED WHOLE WHEAT MUFFINS</p>
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">45 mins <img class="ml-md-5" src="food_recipe_css/4star.png" height="30px" width="120px" alt=""></p>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/cookies.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">HEALTHY BREAKFAST</h6>
                                <p class="card-text">HEALTHY HONEY BREAKFAST COOKIES</p>
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">30 mins <img class="ml-md-5" src="food_recipe_css/4star.png" height="30px" width="120px" alt=""></p>
                            </div>
                        </div>
                    </a>
                </div>
