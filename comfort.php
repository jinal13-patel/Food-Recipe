...
<body>
    <header>
        ...
        <div class="jumbotron text-center">
            <h1 class="text-capitalize">Comfort Food Recipes</h1>
            <p class="mb-0">Had a long day? Need a hug? Look to our comfort food recipes, from mac and cheese to rice pudding.</p>
        </div>
    </header>
    <section>
