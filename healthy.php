...
<body>
    <header>
        ...
        <div class="jumbotron text-center">
            <h1 class="text-capitalize">Healthy Breakfast Recipes</h1>
            

            <p class="mb-0">Morning, sunshine! Wake up to heathy breakfasts, from Overnight Oats to Make-Ahead Spinach & Feta Breakfast Wraps.</p>
        </div>
    </header>
    <section>
                    ...
                    <a href="#">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">30 mins <img class="ml-md-5" src="food_recipe_css/5star.png" height="30px" width="120px" alt=""></p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="#">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">35 mins <img class="ml-md-5" src="food_recipe_css/5star.png" height="30px" width="120px" alt=""></p>
                            </div>
                        </div>
                    </a>
                </div>
