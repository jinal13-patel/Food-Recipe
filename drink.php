...
<body>
    ...
    <header>
        ...
        <div class="jumbotron text-center">
            <h1 class="text-uppercase">DRINKS</h1>
            

            <p class="mb-0">Welcome to our depot for all things drink. You'll find refreshing summer lemonade and spritzers, steaming hot chocolate, and healthy smoothies. Mixing up a cocktail? We have plenty of those, too, with and without alcohol. Bottom's up!</p>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/mojitococtail.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                
                                <p class="card-text">Mojito Cocktail</p>
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">05 mins
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/winterorange.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                               
                                <p class="card-text">Winter Spiced Orange Mocktail</p>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/copycat.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                
                                <p class="card-text">Copycat Shamrock Shake</p>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/chai.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                
                                <p class="card-text">Homemade Chai</p>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/coffee.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                
                                <p class="card-text">Cold Brew Coffee</p>
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">15 mins
                                    <img class="ml-md-5" src="food_recipe_css/5star.png" height="30px" width="120px" alt=""></p>
                            </div>
                        </div>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/mangolassi.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                
                                <p class="card-text">Mango Lassi</p>
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">30 mins
                                    <img class="ml-md-5" src="food_recipe_css/4.5star.jpg" height="40px" width="125px" alt="">
                                </p>
                            </div>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/greensmoothie.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                
                                <p class="card-text">Easy Green Smoothie</p>
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">20 mins
                                    <img class="ml-md-5" src="food_recipe_css/5star.png" height="30px" width="120px" alt=""></p>
                            </div>
                        </div>
                    </a>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/coconut.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                               
                                <p class="card-text">Coconut White Russian</p>
