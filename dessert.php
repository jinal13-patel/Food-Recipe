...
<body>
    <header>
        ...
        <div class="jumbotron text-center">
            <h1 class="text-uppercase">Dessert Recipes</h1>
            
            <p class="mb-0">Whether you're looking for a snack cake, lunchbox cookie, or showstopper for your dinner party, we've got scores of dessert recipes to choose from.</p>
        </div>
    </header>
    <section>
        <div class="container">
            <div class="row mb-5">
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="oats.php">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/apple.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">DESSERTS</h6>
                                <p class="card-text">BAKED APPLES</p>
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">50 mins
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/butter.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">DESSERTS</h6>
                                <p class="card-text">BUTTERSCOTCH PUDDING</p>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/chocolate.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">DESSERTS</h6>
                                <p class="card-text">EASY CHOCOLATE PUDDING IN MICROWAVE</p>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/tiramisu.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">DESSERTS</h6>
                                <p class="card-text">CLASSIC TIRAMISU</p>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/brownie.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">DESSERTS</h6>
                                <p class="card-text">CARAMEL BROWNIES</p>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/indian.jfif" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">DESSERTS</h6>
                                <p class="card-text">INDIAN PUDDING</p>
