...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <h1 class="text-capitalize">Vegan Breakfast Recipes</h1>
            <p class="mb-0">Vegan breakfast recipes start you going strong. Find smoothies, overnight oats, and more vegan breakfast ideas!</p>
        </div>
    </header>
    <section>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">07 mins
                                    <img class="ml-md-5" src="food_recipe_css/5star.png" height="30px" width="120px" alt="">
                                </p>
                            </div>
                        </div>
                    </a>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">40 mins
                                    <img class="ml-md-5" src="food_recipe_css/4star.png" height="40px" width="125px" alt="">
                                </p>
                            </div>
                        </div>
                    </a>
