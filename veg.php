...
<head>
    ...
    <title>Quick Vegetarian Recipes</title>
</head>
...
<body>
    <header>
        ...
        <div class="jumbotron text-center">
            <h1 class="text-uppercase">Quick Vegetarian Recipes</h1>
            
            <p class="mb-0">Quick vegetarian recipes come together in a flash! We count on these recipes when we need glorious vegetarian food, fast.</p>
        </div>
    </header>
    <section>
        <div class="container">
            <div class="row mb-5">
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="oats.php">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/beans.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">QUICK VEGETARIAN</h6>
                                <p class="card-text">GOCHUJANG GREEN BEANS</p>
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">14 mins
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/salad.jfif" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">QUICK VEGETARIAN</h6>
                                <p class="card-text">CHICKPEA SALAD SANDWHICH</p>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/scs.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">QUICK VEGETARIAN</h6>
                                <p class="card-text">SIMPLE CAULIFLOWER SOUP</p>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/olive.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">QUICK VEGETARIAN</h6>
                                <p class="card-text">OLIVE CROSTINI</p>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/chips.jpg" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                <h6 class="card-title text-dark">QUICK VEGETARIAN</h6>
                                <p class="card-text">HOMEMADE TORTILLA CHIPS</p>
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">25 mins
                                    <img class="ml-md-5" src="food_recipe_css/5star.png" height="30px" width="120px" alt=""></p>
                            </div>
                        </div>
