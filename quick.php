...
<body>
    <header>
        ...
        <div class="jumbotron text-center">
            <h1 class="text-capitalize">Quick Breakfast Recipes</h1>
            <p class="mb-0">In a rush? We have quick breakfast recipes and ideas, from Microwave Poached Eggs to Cinnamon Toast to Omelet in a Mug!</p>
        </div>
    </header>
    <section>
                    ...
                    <a href="#">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">08 mins <img class="ml-md-5" src="food_recipe_css/5star.png" height="30px" width="120px" alt=""></p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="#">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">10 mins <img class="ml-md-5" src="food_recipe_css/4star.png" height="30px" width="120px" alt=""></p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="#">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">10 mins <img class="ml-md-5" src="food_recipe_css/4.5star.jpg" height="40px" width="125px" alt=""></p>
                            </div>
                        </div>
                    </a>
                </div>
