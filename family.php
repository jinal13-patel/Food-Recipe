...
<head>
    ...
    <title>Comfort Dinner Recipes</title>
</head>
...
<body>
    <header>
        ...
        <div class="jumbotron text-center">
            <h1 class="text-capitalize">Family Dinner Recipes</h1>
            <p class="mb-0">Gather around the table for family dinners you’ll enjoy from cooking all the way to the last bite. Or scale up for leftovers! We know it’s tricky to find meals everyone agrees on, so we rounded up recipes with appeal for all ages and tastes.</p>
        </div>
    </header>
    <section>
