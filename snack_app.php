...
<body>
    ...
    <header>
        ...
        <div class="jumbotron text-center">
            <h1 class="text-uppercase">SNACKS & APPETIZERS</h1>
            

            <p class="mb-0">Whether you need a casual pre-dinner nibble or something fancy to take to a holiday party, we’ve got all the appetizing appetizers here for you.</p>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/mangosalsa.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                
                                <p class="card-text">Mango Salsa</p>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/cheesy.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                               
                                <p class="card-text">Cheesy Zucchini Bites</p>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/cannedsalsa.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                
                                <p class="card-text">Canned Tomato Salsa</p>
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">45 mins
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/popcorn.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                
                                <p class="card-text">Perfect Popcorn</p>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/chocolatecover.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                
                                <p class="card-text">Chocolate-covered Pretzels </p>
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">45 mins
                                    <img class="ml-md-5" src="food_recipe_css/5star.png" height="30px" width="120px" alt=""></p>
                            </div>
                        </div>
                ...
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/boiledpeanuts.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                
                                <p class="card-text">Boiled Peanuts</p>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="mt-4 col-lg-4 col-md-4 col-12">
                    <a href="#">
                        <div class="card">
                            <img class="card-img-top" src="food_recipe_css/shrimp.webp" alt="Card image" width="100px"
                                height="300px">
                            <div class="card-body">
                                
                                <p class="card-text">Shrimp Cocktail</p>
                                <p><img class="mr-2" src="food_recipe_css/clock.png" height="20px" width="20px" alt="">45 mins
                                    <img class="ml-md-5" src="food_recipe_css/5star.png" height="30px" width="120px" alt=""></p>
                            </div>
                        </div>
